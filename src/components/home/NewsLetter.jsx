                ...
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
                        ...
                        <p className="mb-6 text-base text-indigo-200 md:text-lg">
                            Subscribe to our newsletter and never miss out on our latest and greatest recipes! Stay up-to-date with our weekly newsletter, featuring new recipes, cooking tips, and food-related articles. Don't wait, sign up today and join our community of food lovers!
                        </p>
